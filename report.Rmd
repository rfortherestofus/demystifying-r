...
survey_responses_today <- read_sheet("https://docs.google.com/spreadsheets/d/1lTjv7EYyGPKzjekBJ29xRqCUxhrMT0nuO4gsW6qEb9s/edit#gid=1882477504") %>% 
...
respondent_locations <- survey_responses_today %>% 
  ...
  geocode(address = what_is_the_city_state_and_country_of_your_primary_residence,
                        method = "osm") %>% 
