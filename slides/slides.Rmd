...
Everything will be posted at https://rfortherestofus.com/presentation/sea/
...
nhanes %>% 
  ...
  mutate(mean_height = round_half_up(mean_height, 1)) %>% 
  mutate(gender = str_to_title(gender)) %>% 
  set_names(c("Gender", "Average Height")) 
```
...
All **materials** from this webinar will be posted at https://rfortherestofus.com/presentation/sea/

---

class: center, middle

![](images/seattle-workshop-poster.png)

???

Register before September 4 for early bird pricing
---
