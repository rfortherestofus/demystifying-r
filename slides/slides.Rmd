...
The first thing you need to do is download the R software. You can download R at the [Posit website](https://posit.co/download/rstudio-desktop/).
...
Download RStudio at the [Posit website](https://posit.co/download/rstudio-desktop/). Ignore the various versions listed there. All you need is the latest version of RStudio Desktop.
